...
const ka: Record<string, string> = {
  ...
  "Board": "დაფა",
  "by {name}": "შემქმნელი: {name}",
  "creator unknown": "შემქმნელი უცნობია",
  "Who created this board": "ვინ შექმნა ეს დაფა",
  "{count} attachment(s)": "{count} დანართი",
  "Table": "ცხრილი",
  "Calendar": "კალენდარი",
  "Timeline": "ქრონოლოგია",
  "View": "ხედი",
  ...
  "Comments and activity": "კომენტარები და აქტივობა",
  ...
  "Reply": "პასუხი",
  "Replying to {name}": "პასუხი {name}-ს",
